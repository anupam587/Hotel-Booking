...
$con = mysql_connect("localhost","root","anupam");
    ...
    if($_POST['standardrooms']+$_POST['deluxrooms']+$_POST['grandrooms']!=$_POST['room']){
    echo "notok";
    }
    else{
    $con = mysql_connect("localhost","root","anupam");
    ...
    mysql_select_db("hotel", $con);
    $adult=$_POST['standardadult']+$_POST['deluxadult']+$_POST['grandadult'];
    $children=$_POST['standardchildren']+$_POST['deluxchildren']+$_POST['grandchildren'];

    $data1="insert into tempbook values($totalcharge,$_POST[standardrooms],$_POST[deluxrooms],$_POST[grandrooms],$adult,$children,'$_POST[checkin]','$_POST[checkout]');";
